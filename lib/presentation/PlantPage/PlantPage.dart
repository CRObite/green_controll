                ...
                children: [
                  ...
                  Container(
                    child: GridView.count(
                      ...
                      childAspectRatio: 2,
                      children: [
                        gridItem('Optimal Temperature', '${state.plant.temperature}'),
                        gridItem('Optimal Humidity', '${state.plant.humidity}'),
                        gridItem('Optimal Lighting ', '0'),
                        gridItem('Optimal CO2 Level', '${state.plant.carbonDioxide}'),
                      ],
                    ),
                  ),
