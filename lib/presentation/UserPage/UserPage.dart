                        ...
                        child: Container(
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                                Text(state.ghs[index].name ?? '???',style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold),),
                                ...
                                Container(
                                    ...
                                    child: Padding(
                                        padding: const EdgeInsets.symmetric(vertical: 0 ,horizontal: 16),
                                        child: Text(state.ghs[index].arduino!.plant!.name ?? '???',style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.white),)
                                    )
                                ),
                              ],
                            ),
